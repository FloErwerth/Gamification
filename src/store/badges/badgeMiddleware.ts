...
export const badgeMiddleware = (api: MiddlewareAPI<Dispatch<GamificationActions>, GamificationModel>) => (next: Dispatch<GamificationActions>) => (action: GamificationActions) => {
